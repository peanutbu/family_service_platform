 ...
 * @author
 * @version 1.0.0
 * @description :mybatis逆向工程生成pojo和mapper
 * @date
 */
public class MyTest {
    @Test
    public void testGenerator() {
        ...
        globalConfig.setAuthor("lian")
                .setOutputDir("D:\\idea_workspace\\family_service_platform\\src\\main\\java")//设置输出路径
        ...
        dataSourceConfig.setDriverName("com.mysql.cj.jdbc.Driver").setUrl("jdbc:mysql://localhost:3306/family_service_platform?serverTimezone=UTC")
                .setUsername("root").setPassword("ljt");
        ...
        packageConfig.setParent("com.msb").setMapper("mapper")
